-- ============================================================================
-- COMPLETE REVENUE BREAKDOWN BY INDIVIDUAL (AM & MGS)
...
-- ============================================================================
-- QUERY 1: STEP 1: Get AM Merchant IDs
-- ============================================================================
...
-- ============================================================================
-- QUERY 2: Revenue Breakdown: Teoh Jun Ling (MGS)
-- ============================================================================
...
-- ============================================================================
-- QUERY 3: Revenue Breakdown: Hon Yi Ni (MGS)
-- ============================================================================
...
-- ============================================================================
-- QUERY 4: Revenue Breakdown: Low Jia Ying (MGS)
-- ============================================================================
...
-- ============================================================================
-- QUERY 5: Revenue Breakdown: Lee Sook Chin (MGS)
-- ============================================================================
...
-- ============================================================================
-- QUERY 6: Revenue Breakdown: Darren (AM - Template)
-- ============================================================================
...
-- Example: If Step 1 shows Darren has 150 merchants, update the VALUES clause

SELECT 
    'Run Step 1 query first to get merchant IDs for Darren' as note,
    'Then update the query below with actual merchant IDs' as instruction;



-- ============================================================================
-- QUERY 7: Revenue Breakdown: Suki (AM - Template)
-- ============================================================================
...
-- TODO: After running Step 1, update merchant_ids in the query below
-- Example: If Step 1 shows Suki has 150 merchants, update the VALUES clause

SELECT 
    'Run Step 1 query first to get merchant IDs for Suki' as note,
    'Then update the query below with actual merchant IDs' as instruction;



-- ============================================================================
-- QUERY 8: Revenue Breakdown: Chia Yee (AM - Template)
-- ============================================================================
...
-- TODO: After running Step 1, update merchant_ids in the query below
-- Example: If Step 1 shows Chia Yee has 150 merchants, update the VALUES clause

SELECT 
    'Run Step 1 query first to get merchant IDs for Chia Yee' as note,
    'Then update the query below with actual merchant IDs' as instruction;



-- ============================================================================
-- QUERY 9: Revenue Breakdown: Hsin Tsi Lim (AM - Template)
-- ============================================================================
...
-- TODO: After running Step 1, update merchant_ids in the query below
-- Example: If Step 1 shows Hsin Tsi Lim has 150 merchants, update the VALUES clause

SELECT 
    'Run Step 1 query first to get merchant IDs for Hsin Tsi Lim' as note,
    'Then update the query below with actual merchant IDs' as instruction;
